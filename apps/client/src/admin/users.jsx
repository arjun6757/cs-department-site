                ...
                <table className='w-full border-collapse text-sm min-h-[50px]'>
                    <thead>
                        <tr className='bg-gray-100'>
                            ...
                            <th className='border border-[#ddd] font-normal p-2 text-gray-800'>Role</th>
                            <th className='border border-[#ddd] font-normal p-2 text-gray-800'>Created At</th>
                    ...
                    <tbody>
                        ...
                        {filteredUsers.map((user, index) => (
                            <tr key={user._id}>
                                ...
                                <td className='border border-[#ddd] p-2 text-center'>{user.role}</td>
