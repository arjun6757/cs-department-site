                                ...
                                <ul className="flex flex-col pl-6">
                                    <li>
                                        <button
                                            ...
                                            name="system"
                                            className="data-[active=true]:bg-[#eee] dark:data-[active=true]:bg-[#272727] p-2 cursor-pointer dark:hover:bg-[#202020] hover:bg-gray-100 rounded inline-flex items-center w-full h-full gap-2.5 outline-blue-500"
                                        >
