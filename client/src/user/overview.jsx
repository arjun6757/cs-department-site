      ...
      <div className="p-4 sm:p-6 pb-2">
        <div className="flex flex-col md:flex-row md:items-center gap-4 sm:gap-8">
          <div className="overview_wrapper flex items-center gap-5 sm:gap-8">
            <div className="h-16 w-16 rounded-full ring-2 border border-[#ddd] ring-blue-300 ring-offset-2 flex items-center justify-center text-gray-500 font-bold text-xl overflow-hidden">
              {user?.username
