import { Calendar, Cog, Mail, Shield, User } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4 sm:gap-8">
          <div className="overview_wrapper flex items-center gap-5 sm:gap-8">
            ...
            <div className="overview_sub_wrapper flex sm:flex-row flex-col gap-4 sm:items-center">
              <div>
                <h1 className="text-md sm:text-2xl font-semibold text-gray-700">
              ...
              <div className="w-fit h-fit px-3 py-1 rounded-full border border-[#ddd] shadow-xs bg-gray-50 text-gray-700 text-xs sm:text-sm font-medium inline-flex items-center">
      ...
      <div className="p-6">
        <div className="flex flex-col gap-8 mt-4">
          <div className="space-y-4">
            <h3 className="text-[16px] font-medium flex items-center gap-2 text-gray-700">
        ...
        {error && (
          <div className="mt-6 p-4 border border-red-200 bg-red-50 text-red-600 rounded-md">
            {error}
          </div>
        )}
      </div>
